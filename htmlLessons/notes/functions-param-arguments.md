...
// Above, if we don't pass any argument to yell function, then it takes the default value in function de 
...
console.log("Running Calculate Bill!!"); const total = billAmount + billAmount taxRate + billAmount tipRate;
return total;
}
